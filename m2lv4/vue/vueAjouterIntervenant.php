...
<div class="conteneur">
    ...
    <main>
        <div class="zoneAjouterIntervenant">
            <h2>Ajouter un intervenant</h2>
            <p style="text-align:center; font-size:16px; color:gray;">
                Remplissez les informations ci-dessous puis cliquez sur <strong>Enregistrer</strong>.
            </p>
            ...
            <form method="post" action="index.php">
                <input type="hidden" name="m2lMP" value="validerAjooutIntervenant">
                <?= csrf_input() ?>

                <p class="formNote">Les champs marqués d'un <strong>*</strong> sont obligatoires.</p>
                ...
                <fieldset class="fieldsetSection">
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="nom" name="nom" placeholder="Nom de famille" value="<?= htmlspecialchars($formData['nom'] ?? '') ?>" required>
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="prenom" name="prenom" placeholder="Prénom" value="<?= htmlspecialchars($formData['prenom'] ?? '') ?>" required>
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="email" name="email" placeholder="adresse@domaine.com" value="<?= htmlspecialchars($formData['email'] ?? '') ?>" required pattern="^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.(com|fr)$" title="Veuillez saisir une adresse email valide se terminant par .com ou .fr">
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="telephone" name="telephone" placeholder="Ex : 01 23 45 67 89" value="<?= htmlspecialchars($formData['telephone'] ?? '') ?>">
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="adresse" name="adresse" placeholder="Numéro, rue, code postal, ville" value="<?= htmlspecialchars($formData['adresse'] ?? '') ?>">
                    </div>
                ...
                <fieldset class="fieldsetSection">
                    <legend>Informations d'embauche</legend>

                    <div class="ligneForm">
                        <label for="statut">Statut *</label>
                        <select id="statut" name="statut" required>
                            <option value="salarie" <?= ( ($formData['statut'] ?? '') === 'salarie') ? 'selected' : '' ?>>Salarié</option>
                            <option value="benevole" <?= ( ($formData['statut'] ?? '') === 'benevole') ? 'selected' : '' ?>>Bénévole</option>
                        </select>
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="date" id="date_embauche" name="date_embauche" value="<?= htmlspecialchars($formData['date_embauche'] ?? '') ?>">
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="rattachement_type" name="rattachement_type" value="<?= htmlspecialchars($formData['rattachement_type'] ?? '') ?>">
                    </div>
                    ...
                    <div class="ligneForm">
                        ...
                        <input type="text" id="rattachement_nom" name="rattachement_nom" value="<?= htmlspecialchars($formData['rattachement_nom'] ?? '') ?>">
                    </div>
                ...
                <div class="formActions" style="text-align:center; margin-top:16px;">
                    <button type="submit" class="btnValider">Enregistrer</button>
                    <a href="index.php?m2lMP=intervenants" class="btnAnnuler" style="margin-left:12px;">Annuler</a>
                </div>
            </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.querySelector('form input[name="m2lMP"][value="validerAjooutIntervenant"]');
        if (!form) return;
        ...
        function showError(fieldName, msg) {
            ...
            if (!field) return;
            var row = field.closest('.ligneForm') || field.parentElement;
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (Object.keys(errors).length > 0) {
                ...
                var firstField = document.querySelector('.messageErreur');
